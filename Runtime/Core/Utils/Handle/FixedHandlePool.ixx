...
namespace Core
{
    ...
    public:
        ...
        void Setup(std::uint16_t maxCount)
        {
            ...
            m_freeList.clear();
            for (std::uint16_t i = 1; i < m_capacity; ++i)
        ...
        Handle Emplace(Args&&... args)
        {
            ...
            std::uint16_t index = m_freeList.back();
            m_freeList.pop_back();
    ...
    private:
        ...
        std::uint16_t m_capacity{ 1 }; // 항상 최소 1 (dummy만 있는 상태)
    };
}